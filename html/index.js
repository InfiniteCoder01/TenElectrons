...
Module['FS_createPath']("/", "Assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/Assets/DsDigii.ttf", "start": 0, "end": 24676}, {"filename": "/Assets/ball.png", "start": 24676, "end": 24838}, {"filename": "/Assets/playerRed.aseprite", "start": 24838, "end": 26185}, {"filename": "/Assets/playerRed.png", "start": 26185, "end": 26593}, {"filename": "/Assets/test.txt", "start": 26593, "end": 26593}, {"filename": "/Assets/tileset.aseprite", "start": 26593, "end": 28249}, {"filename": "/Assets/tileset.png", "start": 28249, "end": 29757}], "remote_package_size": 29757});
...
var ASM_CONSTS = {
  7400: () => { return parseInt(prompt("Level Width:")); },  
 7441: () => { return parseInt(prompt("Level Height:")); },  
 7483: () => { var text = prompt("Level Data:"); var lengthBytes = lengthBytesUTF8(text) + 1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(text, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; },  
 7687: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); alert("Level code is copied to clipboard!") },  
 7780: () => { var text = prompt("New sign message:"); var lengthBytes = lengthBytesUTF8(text) + 1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(text, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; },  
 7990: () => { var text = prompt("Enter command (load - load level (Shift+Enter), save - save level (Enter), reset - reset level (Tab), message(F2) - set sign message for this level):"); var lengthBytes = lengthBytesUTF8(text) + 1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(text, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; },  
 8332: ($0) => { alert(UTF8ToString($0)); },  
 8357: () => { addOnPostRun(function() { if (Module.canvas) Module.canvas.focus(); }); },  
 8429: ($0) => { Asyncify.handleAsync(async () => { var font = new FontFace(UTF8ToString($0).replace(' ', '-').replace('/', '-').replace('.', '-'), FS.readFile(UTF8ToString($0)).buffer); await font.load(); document.fonts.add(font); }); }
};
