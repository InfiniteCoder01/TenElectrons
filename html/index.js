...
Module['FS_createPath']("/", "Assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/Assets/DsDigii.ttf", "start": 0, "end": 24676}, {"filename": "/Assets/ball.png", "start": 24676, "end": 24838}, {"filename": "/Assets/font.ttf", "start": 24838, "end": 214358}, {"filename": "/Assets/playerRed.aseprite", "start": 214358, "end": 215705}, {"filename": "/Assets/playerRed.png", "start": 215705, "end": 216113}, {"filename": "/Assets/test.txt", "start": 216113, "end": 216113}, {"filename": "/Assets/tileset.aseprite", "start": 216113, "end": 218013}, {"filename": "/Assets/tileset.png", "start": 218013, "end": 219894}], "remote_package_size": 219894});
...
var ASM_CONSTS = {
  20488: () => { return parseInt(prompt("Level Width:")); },  
 20529: () => { return parseInt(prompt("Level Height:")); },  
 20571: () => { var text = prompt("Level Data:"); var lengthBytes = lengthBytesUTF8(text) + 1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(text, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; },  
 20775: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); alert("Level code is copied to clipboard!") },  
 20868: () => { var text = prompt("New sign message (Use \\n to put newline character):").replace("\\n", "\n"); var lengthBytes = lengthBytesUTF8(text) + 1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(text, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; },  
 21139: () => { var text = prompt("Enter command (load - load level (Shift+Enter), save - save level (Enter), reset - reset level (Tab), message(F2) - set sign message for this level):"); var lengthBytes = lengthBytesUTF8(text) + 1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(text, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; },  
 21481: () => { addOnPostRun(function() { if (Module.canvas) Module.canvas.focus(); }); },  
 21553: ($0) => { Asyncify.handleAsync(async () => { var font = new FontFace(UTF8ToString($0).replace(' ', '-').replace('/', '-').replace('.', '-'), FS.readFile(UTF8ToString($0)).buffer); await font.load(); document.fonts.add(font); }); }
};
  ...
  var Asyncify = {State:{Normal:0,Unwinding:1,Rewinding:2,Disabled:3},state:0,StackSize:4096,currData:null,handleSleepReturnValue:0,exportCallStack:[],callStackNameToId:{},callStackIdToName:{},callStackId:0,asyncPromiseHandlers:null,sleepCallbacks:[],getCallStackId:function(funcName) {
        ...
        var ASYNCIFY_IMPORTS = ["env.emscripten_asm_const_int","env.emscripten_asm_const_ptr","env.invoke_*","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await","env._dlopen_js","env.__asyncjs__*"].map((x) => x.split('.')[1]);
